...
//determine if the user wants to include uppercase characters in the password
...
//determine whether the user wants to use numbers in the password
...
//determines whether the user wants to use special characters in the password
function determineSpecial(){
 ...
 // used to take all the input from the previous functions and generate a password using a random number generator and 
 //the charAt method 
